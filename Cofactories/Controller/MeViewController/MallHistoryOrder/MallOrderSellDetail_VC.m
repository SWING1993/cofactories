...
@interface MallOrderSellDetail_VC ()<UIAlertViewDelegate> {
    UIButton *lastButton;
}
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        ...
        [cell reloadMallSellHistoryOrderDetailDataWithMallSellHistoryModel:self.goodsModel];
        return cell;
        ...
        [cell reloadReceiveAddressWithMallSellHistoryModel:self.goodsModel];
        return cell;
    } else {
        MallOrderStatusCell *cell = [tableView dequeueReusableCellWithIdentifier:mallStatusCellIdentifier forIndexPath:indexPath];
        [cell reloadMallSellHistoryOrderTimeWithMallSellHistoryModel:self.goodsModel];
        return cell;
    }
