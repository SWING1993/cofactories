...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier withRowSize:(CGSize)rowSize{
    if (self = [super initWithStyle:style reuseIdentifier:reuseIdentifier]) {
        ...
        _typeLabel = [[UILabel alloc]initWithFrame:CGRectMake(15, 0, rowSize.width-40, rowSize.height/2)];
        _typeLabel.font = [UIFont boldSystemFontOfSize:15.5f];
        _typeLabel.numberOfLines = 2;
        _typeLabel.textAlignment = NSTextAlignmentLeft;
        _typeLabel.textColor = kBlack;
        [self addSubview:_typeLabel];
        
        _timeLabel = [[UILabel alloc]initWithFrame:CGRectMake(15, rowSize.height/2, rowSize.width-40, rowSize.height/2)];
