...
- (void)viewDidLoad {
    ...
    detailArray = @[@"色彩预测、款式趋势、热销单品实拍、品牌订货会、系列大片直推", @"流行元素预测、时尚潮牌解析、品牌定会货、街拍潮流、电商TOP", @"随时观看国内外热销单品、款式细节、童装设计、潮流趋势预测", @"国际面料展会实况详情、面料工艺、色卡、设计细节", @"洞悉服装产业行情、品牌咨询访谈、财报、交易、焦点", @"明星时尚、娱乐星闻、奢侈品带动趋势", @"原创设计师访谈、品牌解析、设计之家", @"有病区、有病得知、没病找事、病例分析、一吐为快"];
}
