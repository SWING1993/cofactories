...
//    myScrollView.backgroundColor = [UIColor yellowColor];
    ...
    NSArray *photoArray = @[@"1.jpg", @"2.jpg", @"3.jpg"];
    NSArray *titleArray = @[@"查找面料商家", @"查找辅料商家", @"查找机械设备商家"];
    NSArray *detailTitleArray = @[@"最全面料商家聚集地", @"最全辅料商家聚集地", @"最全机械设备商家聚集地"];
    ZGYSupplyMarketView *supplyMarketView1 = [[ZGYSupplyMarketView alloc] initWithFrame:CGRectMake(0, 0, kScreenW, 370) photoArray:photoArray titleArray:titleArray detailTitleArray:detailTitleArray];
    supplyMarketView1.tag = 222;
    supplyMarketView1.delegate = self;
    [myScrollView addSubview:supplyMarketView1];
    ZGYSupplyMarketView *supplyMarketView2 = [[ZGYSupplyMarketView alloc] initWithFrame:CGRectMake(kScreenW, 0, kScreenW, 370) photoArray:photoArray titleArray:titleArray detailTitleArray:detailTitleArray];
