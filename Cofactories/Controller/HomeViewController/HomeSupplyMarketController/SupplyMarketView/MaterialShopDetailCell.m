...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier
{
    ...
    if (self) {
        ...
        self.salePriceLabel = [[UILabel alloc] initWithFrame:CGRectMake(kMargin, CGRectGetMaxY(self.materialLabel.frame), kScreenW - 2*kMargin, 30)];
        self.salePriceLabel.font = [UIFont systemFontOfSize:14];
        self.salePriceLabel.textColor = kLightGaryColor;
        [self addSubview:self.salePriceLabel];

        self.marketPriceLeftLabel = [[UILabel alloc] initWithFrame:CGRectMake(kMargin, CGRectGetMaxY(self.salePriceLabel.frame), 40, 30)];
        ...
        self.marketPriceRightLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.marketPriceLeftLabel.frame), CGRectGetMaxY(self.salePriceLabel.frame), 60, 30)];
        ...
        self.leaveCountLabel = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(self.marketPriceRightLabel.frame), CGRectGetMaxY(self.salePriceLabel.frame), kScreenW - 2*kMargin - 120, 30)];
