...
//        [self addSubview:self.priceRightLabel];
        ...
        self.lineView = [[UIView alloc] initWithFrame:CGRectMake(self.marketPriceRightLabel.frame.origin.x, self.marketPriceRightLabel.frame.origin.y + self.marketPriceRightLabel.frame.size.height/2.0, self.marketPriceRightLabel.frame.size.width, 1)];
        self.lineView.backgroundColor = [UIColor colorWithRed:83.0/255.0 green:83.0/255.0 blue:83.0/255.0 alpha:1.0];
