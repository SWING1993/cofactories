...
//        self.backgroundColor = [UIColor whiteColor];
        self.photoView = [[UIImageView alloc] initWithFrame:CGRectMake(kProcessMargin, kProcessMargin - 5*kZGY, (kScreenW - kProcessMargin*6)/3, (kScreenW - kProcessMargin*6)/3)];
