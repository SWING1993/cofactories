...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.marketTextLabel.textColor = [UIColor colorWithRed:70.0f/255.0f green:126.0f/255.0f blue:220/255.0f alpha:1.0f];
...
//        self.marketTextLabel.font = [UIFont systemFontOfSize:14*kZGY];
        ...
        self.marketDetailLabel.font = [UIFont systemFontOfSize:10*kZGY];
        ...
        self.marketImage.backgroundColor = [UIColor lightGrayColor];
