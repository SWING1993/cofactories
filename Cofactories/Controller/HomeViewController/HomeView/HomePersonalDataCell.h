...
@property (nonatomic, strong) UIImageView *personStatusImage;
@property (nonatomic, strong) UILabel *personNameLabel, *personScoreLabel, *personWalletLeft;//个人资料（名字，钱包余额，用户类型）
