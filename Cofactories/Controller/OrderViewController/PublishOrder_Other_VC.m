...
- (void)initTableView{
    ...
    UILabel *amountLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 45, 100, 44)];
    ...
    _amountTF = [[UITextField alloc] initWithFrame:CGRectMake(155, 45+7, kScreenW - 180, 30)];
    ...
    UILabel *timeLabel = [[UILabel alloc] initWithFrame:CGRectMake(50, 45+44, 70, 44)];
    ...
    _customeView = [[CustomeView alloc] initWithFrame:CGRectMake(155, 45+44+7, kScreenW-180, (kScreenW-180)/6.f)];
    [headerView addSubview:_customeView];
    
    UILabel *commentLabel = [[UILabel alloc] initWithFrame:CGRectMake(60, 45+44+44, 70, 44)];
    commentLabel.font = [UIFont systemFontOfSize:14];
    commentLabel.text = @"备注";
    [headerView addSubview:commentLabel];
    
    _commentTF = [[UITextField alloc] initWithFrame:CGRectMake(155, 45+44+44+7, kScreenW - 180, 30)];
